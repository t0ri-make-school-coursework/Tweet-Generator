...
<body style="display:flex;flex-flow:column nowrap;justify-content:center;align-items:center;width:75vw;margin:auto;background-color:#fff">
  <h1 style="color:#fa9c1e;font-size:100px;text-shadow: 2px 2px #4b4c4e;text-align:center">{}</h1>
</body>
</html>
"""
